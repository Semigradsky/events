...
| | | |
| --- | :---: | --- |
| EJsE Sails.JS as MockServer  | Олег Пименов |   |
| Пробуем оптимизировать сборку webpack  | Елена Сизова |   |
| Redux + Angular 1.5.x  | Динара Крылова |   |
| Автоматическое e2e тестирование в Облаке  | Иван Николаев |   |
...
| | | |
| --- | :---: | --- |
| Сложно ли написать приложение на React Native?  | Дмитрий Локтев |   |
| Где лучше работать в стартапе или в большой компании?  | Евгений Кот |   |
| Как писать unit-тесты для Rx.js?  | Кирилл Сухомлин |   |
| Про REPL Driven Development и Clojure (Script).  | Николай Рыжиков |   |
| Как упаковать node.js приложение в Docker?  | Станислав Гуменюк |   |
| Короткое введение в WebAssembly.  | Вячеслав Лапин |   |
## MoscowJS 30 - Apr 28 
| | | |
| --- | :---: | --- |
